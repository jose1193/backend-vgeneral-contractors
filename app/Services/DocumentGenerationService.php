...
class DocumentGenerationService
{
    ...
    private function prepareTemplateValues(
        ...
        // Verificar si el claim tiene un affidavit antes de agregar los valores relacionados
        ...
        // Add CEO initials
        $ceoInitials = $this->namingService->getInitials($existingClaim->signature->user->name . ' ' . $existingClaim->signature->user->last_name);
